...
$this->_pages['mods/ecomm/success_monerisusa.php']['title_var']    = 'ec_payments';
$this->_pages['mods/ecomm/error_monerisca.php']['title_var']    = 'ec_payments';
$this->_pages['mods/ecomm/success_monerisca.php']['title_var']    = 'ec_payments';
$this->_pages['mods/ecomm/failure_monerisca.php']['title_var']    = 'ec_payments';
...
if (admin_authenticate(AT_ADMIN_PRIV_ECOMM, TRUE) || admin_authenticate(AT_ADMIN_PRIV_ADMIN, TRUE)) {
	...
	$this->_pages['mods/ecomm/payments_admin.php']['children'] = array('mods/ecomm/index_admin.php','mods/ecomm/index_admin_approve.php', 'mods/ecomm/index_instructor.php','mods/_core/enrolment/admin/index.php', );
	
	$this->_pages['mods/ecomm/index_instructor.php']['title_var'] = 'ec_payments_courses';	
	
	$this->_pages['mods/ecomm/index_instructor.php']['children']  = array('mods/_core/enrolment/admin/index.php');
	
	$this->_pages['mods/ecomm/index_instructor.php']['parent']    = 'mods/ecomm/payments_admin.php';
	...
	$this->_pages['mods/_core/enrolment/admin/index.php']['children']       = array('mods/ecomm/index_instructor.php');
